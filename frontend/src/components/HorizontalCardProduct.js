    ...
    return (
        <div className="container mx-auto px-4 my-6 relative">
            ...
            <div className='flex items-center gap-4 md:gap-6 overflow-scroll scrollbar-none transition-all' ref={scrollElement}>
                ...
                <button  className='bg-white shadow-md rounded-full p-1 absolute left-0 text-lg hidden md:block z-10' onClick={scrollLeft}>
                    <FaAngleLeft/>
                </button>
                <button  className='bg-white shadow-md rounded-full p-1 absolute right-0 text-lg hidden md:block z-10' onClick={scrollRight}>
                    <FaAngleRight/>
                </button>
